...
class ShowEventAdmin extends Component{
       ...
       // redirect based on successful login
        ...
        return(
            <>
                ...
                {/* <Container  style={{paddingLeft: 450,paddingBottom: 100, }}> */}
                <Row style={{paddingLeft: 400, paddingTop: 50}}>
                    <Col m={4} s={4}>
                        <Select value={this.state.filterValue} style={{width: 10}} onChange={this.handleFilter}>
                    ...
                    <Col m={4} s={4}>
                        <Button large class="center" onClick = {this.generateData}  waves="light">Generate Data</Button>
                    </Col>
                </Row>
                {/* </Container> */}
                <SideNavItem divider />
